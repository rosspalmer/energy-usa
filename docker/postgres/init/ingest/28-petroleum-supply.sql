...
CREATE TABLE IF NOT EXISTS ingest.eia_petroleum_supply (
...
CREATE INDEX IF NOT EXISTS idx_petroleum_supply_area ON ingest.eia_petroleum_supply (duoarea, period);
