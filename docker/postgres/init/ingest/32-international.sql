...
CREATE TABLE IF NOT EXISTS ingest.eia_international (
...
CREATE INDEX IF NOT EXISTS idx_international_country ON ingest.eia_international (country_region_id, period);
