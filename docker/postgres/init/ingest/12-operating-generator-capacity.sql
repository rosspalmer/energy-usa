...
CREATE TABLE IF NOT EXISTS ingest.eia_operating_generator_capacity (
...
CREATE INDEX IF NOT EXISTS idx_eia_gen_capacity_state ON ingest.eia_operating_generator_capacity (stateid, period);
