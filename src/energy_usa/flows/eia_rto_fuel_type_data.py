...
EIA_RTO_FUEL_TYPE_DATA_COLUMNS = ["value", "value-units"]
...
@flow(name="ingest-eia-rto-fuel-type-data", retries=2)
async def ingest_eia_rto_fuel_type_data(
    ...
    total = upsert_rto_fuel_type_data_task(settings.effective_ingest_url, data)
